        ...
        <div class="card-body">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">1</th>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','6am') ? 'checked': '' }}  @endif  value="6am">6am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','6.20am') ? 'checked': '' }}  @endif  value="6.20am">6.20am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','6.40am') ? 'checked': '' }}  @endif value="6.40am">6.40am</td>
                </tr>
                 <tr>
                  <th scope="row">2</th>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','7am') ? 'checked': '' }}  @endif  value="7am">7am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','7.20am') ? 'checked': '' }}  @endif  value="7.20am">7.20am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','7.40am') ? 'checked': '' }}  @endif value="7.40am">7.40am</td>
                </tr>
                 <tr>
                  <th scope="row">3</th>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','8am') ? 'checked': '' }}  @endif  value="8am">8am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','8.20am') ? 'checked': '' }}  @endif  value="8.20am">8.20am</td>
                  <td><input type="checkbox" name="time[]"@if (isset($times)) {{$times->contains('time','8.40am') ? 'checked': '' }}  @endif  value="8.40am">8.40am</td>
                </tr>

                <tr>
                  <th scope="row">4</th>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','9am') ? 'checked': '' }}  @endif  value="9am">9am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','9.20am') ? 'checked': '' }}  @endif  value="9.20am">9.20am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','9.40am') ? 'checked': '' }}  @endif  value="9.40am">9.40am</td>
                </tr>

                <tr>
                  <th scope="row">5</th>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','10am') ? 'checked': '' }}  @endif  value="10am">10am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','10.20am') ? 'checked': '' }}  @endif value="10.20am">10.20am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','10.40am') ? 'checked': '' }}  @endif  value="10.40am">10.40am</td>
                </tr>

                <tr>
                  <th scope="row">6</th>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','11am') ? 'checked': '' }}  @endif  value="11am">11am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','11.20am') ? 'checked': '' }}  @endif  value="11.20am">11.20am</td>
                  <td><input type="checkbox" name="time[]" @if (isset($times)) {{$times->contains('time','11.40am') ? 'checked': '' }}  @endif  value="11.40am">11.40am</td>
                </tr>
...
@else
<h3>Your appointment time list: 
  {{ $myappointments->count()  }}</h3>
