    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="app">
          ...
          <div class="form-group">
            ...
            <textarea name="symptoms" class="form-control" placeholder="" required>
          ...
          <div class="form-group">
            ...
            <textarea name="procedure_to_use_medicine" class="form-control" placeholder="" required>
          ...
          <div class="form-group">
            ...
            <textarea name="feedback" class="form-control" placeholder="" required>
