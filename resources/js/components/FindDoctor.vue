...
<div>
     <div class="card">
         ...
         <div class="card-body">
          <datepicker class="my-datepicker" :disabledDates="disabledDates" calendar-class="my-datepicker_calendar" :format="customDate" v-model="time" :inline=true></datepicker>
         </div>
     </div>
